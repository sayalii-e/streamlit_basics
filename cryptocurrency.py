...
def load_data():
    ...
    listings = coin_data['props']['initialState']['cyptocurrency']['listingLatest']['data']
    for i in listings:
...
percent_dict = {"7d":'percent_dchange_7d', "24h" : 'percent_change_24h', "1h" : 'percent_change_1h'}
